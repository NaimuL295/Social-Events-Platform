...
export  const router = createBrowserRouter([
  {
    ...
    children:[
      ...
      {path:"createEvent",
        ...
        {path:"/details/:id",
          loader:({params})=>axios.get(`https://server-side-omega-umber.vercel.app/event-one/${params.id}`),
          element:<Protect>  <ComingDetails></ComingDetails>  </Protect>,
           hydrateFallbackElement:<Spinner></Spinner>
        },
        {path:"joinEvent",element:<Protect> <JoinEvent></JoinEvent> </Protect> },
        {path:"/update/:id",
         loader:({params})=>axios.get(`https://server-side-omega-umber.vercel.app/event-manage-one/${params.id}`),
