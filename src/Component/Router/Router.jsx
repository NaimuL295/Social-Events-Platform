...
export  const router = createBrowserRouter([
  {
    ...
    children:[
      ...
      {path:"createEvent",
        ...
        {path:"/details/:id",
          loader:({params})=>axios.get(`https://brash-celery-production.up.railway.app/event-one/${params.id}`),
          element:<Protect>  <ComingDetails></ComingDetails>  </Protect>,
           hydrateFallbackElement:<Spinner></Spinner>
        },
        {path:"joinEvent",element:<Protect> <JoinEvent></JoinEvent> </Protect> },
        {path:"/update/:id",
         loader:({params})=>axios.get(`https://brash-celery-production.up.railway.app/event-manage-one/${params.id}`),
          hydrateFallbackElement:<Spinner></Spinner>,
